	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
                ...
                <a href="admin-view-payments.php"><i class="pull-left fa fa-dollar icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
$k=$query->rowCount();
?>
                      <h5><strong><?php echo htmlentities($k);?></strong></h5>
                      <span>Payments</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                <a href="admin-view-train.php"><i class="pull-left fa fa-train user1 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
?>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                <a href="admin-view-employee.php"><i class="pull-left fa fa-group user2 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
?>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                <a href="admin-view-booking.php"><i class="pull-left fa fa-ticket dollar1 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
$sql ="SELECT id from  bookings where status='0'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$k=$query->rowCount();
?>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                <a href="admin-view-passenger.php"><i class="pull-left fa fa-users dollar2 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
{				?>
            ...
            <div class="tables">
					<h2 class="title1">Passenenger Details</h2>
