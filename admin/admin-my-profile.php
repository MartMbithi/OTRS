		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
					...
					<h2 class="title1">Railway Management System Admin Profile Details</h2>
...
{				?>
                                          ...
                                          <td><?php echo htmlentities($result->password);?></td>-->
                                            ...
                                            <td><a href="admin-update-password.php" onclick="return confirm('Do You Want To Edit This Admin Profile ?');"><i class="fa fa-edit"></i></a></td>
										</tr> 
                         </tbody> 
                         <?php $cnt=$cnt+1; }} ?>
                         </table> 
