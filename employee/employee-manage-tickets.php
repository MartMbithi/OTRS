...
$query -> execute();
$msg="Ticket Records Successfully Removed";
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">Railway Management System Manage Ticket Bookings</h2>
...
{				?>
                                          ...
                                          <td><?php echo htmlentities($result->password);?></td>-->
                                            <td><a href="employee-manage-tickets.php?del=<?php echo $result->id;?>" onclick="return confirm('Do You Want To Remove This Record ?');"><i class="fa fa-trash-o"></i></a></td>
										</tr> 
                         </tbody> 
                         <?php $cnt=$cnt+1; }} ?>
                         </table> 
