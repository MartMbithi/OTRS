...
$query -> execute();
$msg="Passenger Records Successfully Removed";
		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
					...
					<h2 class="title1">Railway Management System Passenger Details</h2>
...
{				?>
                                          ...
                                          <td><?php echo htmlentities($result->password);?></td>-->
                                            <td><a href="employee-manage-passenger.php?del=<?php echo $result->id;?>" onclick="return confirm('Do You Want To Remove This  Record ?');"><i class="fa fa-trash-o"></i></a></td>
										</tr> 
                         </tbody> 
                         <?php $cnt=$cnt+1; }} ?>
                         </table> 
