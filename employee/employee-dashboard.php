	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
                ...
                <a href="employee-view-train.php"><i class="pull-left fa fa-train icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
?>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                <a href="employee-view-bookings.php"><i class="pull-left fa fa-ticket user1 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
?>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                <a href="employee-view-passenger.php"><i class="pull-left fa fa-user user2 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
?>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                <a href="employee-view-payments.php"><i class="pull-left fa fa-dollar dollar1 icon-rounded"></i></a>
                    <div class="stats">
                    <?php
...
?>
            ...
            <div class="tables">
					<h2 class="title1">Passenger Details</h2>
